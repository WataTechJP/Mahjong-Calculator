...
export function StartGameScreen({ onBack }: Props) {
  ...
  const [enable30000Rule, setEnable30000Rule] = useState(false);
  const { startGame } = useGameStore();
  const borderAnimations = useRef(
    names.map(() => new Animated.Value(0)),
  ).current;
      ...
      <View style={styles.ruleSection}>
        ...
        <View style={styles.modeRow}>
          <TouchableOpacity
            style={[
              styles.modeButton,
              gameMode === "tonpu" && styles.modeButtonActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.modeText,
                gameMode === "tonpu" && styles.modeTextActive,
              ]}
            >
              東風戦
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.modeButton,
              gameMode === "hanchan" && styles.modeButtonActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.modeText,
                gameMode === "hanchan" && styles.modeTextActive,
              ]}
            >
              半荘
            </Text>
